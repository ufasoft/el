...
static Tuple5 CalcBranch(uint32_t *p, const uint32_t w[], const byte tableR[], const byte tableS[], const uint32_t tableK[], const PFN_F tableF[]) {
...
void RIPEMD160::HashBlock(void *dst, const byte *src, uint64_t counter) noexcept {
